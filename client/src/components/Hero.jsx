...
const Hero = () => {
  ...
  <div className="pt-4 flex flex-row gap-x-3">
    <button className="bg-white text-blue-800 px-2.5 py-2.5 rounded-lg font-semibold text-xs cursor-pointer hover:bg-blue-100 transition">
        Shillong VTT Previsit Report
    </button>
    <button className="bg-white text-blue-800 px-3 py-1.5 rounded-lg font-semibold text-xs cursor-pointer hover:bg-blue-100 transition">
                        ...
                        <SwiperSlide key={idx}>
                            ...
                            >
                                ...
                                <div className="px-6 py-5">
                                   ...
                                   <button className="bg-amber-50 text-black text-sm font-semibold px-4 py-2 rounded-xl cursor-pointer hover:bg-amber-100 transition">
  Read More →
</button>
