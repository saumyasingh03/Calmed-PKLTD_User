...
const Gallery = () => {
    const navigate = useNavigate();
    const [images, setImages] = useState([]); // Image data from backend
    ...
    return (
        <div className="px-4 sm:px-6 lg:px-10 pt-10 pb-20 mx-auto">
            ...
            {/* ===== Gallery Title ===== */}
            <h2 className='flex items-center justify-center text-[#005595] text-6xl font-semibold py-8 mb-20'>
            ...
            {selectedImage && (
                ...
                >
                    <div
                        onClick={(e) => e.stopPropagation()} // Prevent click bubbling inside modal
                        className="relative max-w-4xl w-full mx-auto bg-white rounded-xl overflow-hidden shadow-2xl flex flex-col"
                    >
                        <img
                            src={selectedImage.imageUrl}
                            alt={selectedImage.title || "Zoomed Image"}
                            className="w-full h-auto max-h-[75vh] object-contain bg-gray-100"
                        />
                        <div className="p-6 text-center">
                            <h2 className="text-xl font-bold text-blue-900 mb-2">
